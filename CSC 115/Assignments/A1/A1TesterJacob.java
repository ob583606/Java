...
public class A1TesterJacob {
	...
	public static void testGreatestCommonDenominator() {
		...
		System.out.println("Testing greatestCommonDenominator(0, 0)");
		result = A1Exercises.greatestCommonDenominator(27,21);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(0, 0)");
		result = A1Exercises.greatestCommonDenominator(35, 5);
		expected = 5;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(0, 0)");
		result = A1Exercises.greatestCommonDenominator(12, 24);
		expected = 12;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing greatestCommonDenominator(0, 0)");
		result = A1Exercises.greatestCommonDenominator(37, 24);
		expected = 1;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
	...
	public static void testCountMatches() {
		...
		int expected = 0;
		int[] arr1 = {2, 3, 2, 0};
		int[] arr2 = {5, 6, 2, 0, 6, 6};
		int[] arr3 = {6, 7, 8, 8, 9, 0, 8, 2, 8};
		int[] empty = {};
		...
		System.out.println("Testing countMatches(arr1, 6)");
		result = A1Exercises.countMatches(arr2, 6);
		expected = 3;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);

		System.out.println("Testing countMatches(empty, 2)");
		result = A1Exercises.countMatches(empty, 2);
		expected = 0;
		System.out.println("Expected: "+expected);
		System.out.println("Returned: "+result);
